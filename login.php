...
<head>
    ...
    <title>TuCupon | Iniciar Sesión</title>
...
<body>
    ...
    <path class="lash-right" d="M 72 18 Q 80 12 88 18" stroke="#1d1d1f" stroke-width="2.5" fill="none" stroke-linecap="round"/>
        ...
        <div class="form-side">
            <div class="auth-card">
                ...
                <p>Ingresa para guardar tus cupones favoritos.</p>
    ...
    <div class="input-box">
        ...
        <div class="password-wrapper">
            <input type="password" id="password" name="password" placeholder="Tu clave secreta" required>
            <button type="button" class="toggle-password" id="togglePassword">👁️</button>
        </div>
    </div>
    <div id="captcha-container" style="display: none; margin-bottom: 15px; justify-content: center;">
    <div class="g-recaptcha" data-sitekey="6Lc94b4sAAAAAL9ZyitOQDOCPzY7b9QB8YhCzLkq"></div>
</div>
    <button type="submit" class="btn-auth">Ingresar ahora</button>
    <?php
// Asegúrate de tener estas variables con tus llaves reales
$client_id = '15019764602-e4ecjkajqbqc6kkjka6jeitrm0slkg36.apps.googleusercontent.com'; 
...
<div style="display: flex; align-items: center; margin: 20px 0;">
    ...
    <span style="margin: 0 10px; color: #86868b; font-size: 13px;">o ingresa con</span>
    <hr style="flex: 1; border: 0; border-top: 1px solid #f2f2f7;">
</div>
